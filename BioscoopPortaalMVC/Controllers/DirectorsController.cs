...
namespace BioscoopPortaalMVC.Controllers
{
    ...
    public class DirectorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,DateOfBirth")] Director director)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,DateOfBirth")] Director director)
        {
            if (id != director.Id)
            {
                return NotFound();
